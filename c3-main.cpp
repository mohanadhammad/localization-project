...
{  	
	...
	// ndt.setStepSize(1.0); // setting maximum step size for More-Thuente line search
	...
	// std::cout << "Normal Distributions Transform has converged:" << ndt.hasConverged () << " score: " << ndt.getFitnessScore () <<  " time: " << time.toc() <<  " ms" << std::endl;
